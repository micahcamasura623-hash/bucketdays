...
const ACTIVITIES = [
  { id:1, name:"Rage Buggy Off-Road", cat:"Adrenaline", price:70, tier:1, beginner:true, solo:true, area:"Redhill, Surrey", rating:4.8, blurb:"Throw a roll-caged dirt buggy round a mud track. No licence needed.", emoji:"🏎️", img:"https://picsum.photos/seed/bucketday1/400/300", url:"#" },
  ...
  { id:3, name:"Indoor Skydiving", cat:"Adrenaline", price:55, tier:1, beginner:true, solo:true, area:"Basingstoke", rating:4.7, blurb:"Float on a column of air. Weatherproof freefall, any day.", emoji:"🪂", img:"https://picsum.photos/seed/bucketday3/400/300", url:"#" },
  { id:4, name:"Tandem Skydive", cat:"Adrenaline", price:230, tier:1, beginner:true, solo:true, area:"North London", rating:4.9, blurb:"10,000ft, strapped to a pro. The one you'll never forget.", emoji:"☁️", img:"https://picsum.photos/seed/bucketday4/400/300", url:"#" },
  ...
  { id:6, name:"Aeroplane Trial Lesson", cat:"Flying", price:165, tier:1, beginner:true, solo:true, area:"Denham", rating:4.9, blurb:"Take the controls over the Chilterns. You actually fly it.", emoji:"✈️", img:"https://picsum.photos/seed/bucketday6/400/300", url:"#" },
  ...
  { id:9, name:"Clay Pigeon Shooting", cat:"Shooting", price:50, tier:1, beginner:true, solo:true, area:"West London", rating:4.8, blurb:"Smash your first clay within minutes. Pro instructor included.", emoji:"🎯", img:"https://picsum.photos/seed/bucketday9/400/300", url:"#" },
  ...
  { id:19, name:"Thames Evening Cruise", cat:"Days Out", price:37, tier:1, beginner:true, solo:true, area:"Westminster Pier", rating:4.7, blurb:"Landmarks lit gold, gliding under Tower Bridge. Two hours.", emoji:"🛳️", img:"https://picsum.photos/seed/bucketday19/400/300", url:"#" },

...
const ACTIVITIES = [
  { id:1, name:"Rage Buggy Off-Road", cat:"Adrenaline", price:70, tier:1, beginner:true, solo:true, area:"Redhill, Surrey", rating:4.8, blurb:"Throw a roll-caged dirt buggy round a mud track. No licence needed.", emoji:"🏎️", img:"https://picsum.photos/seed/bucketday1/400/300", url:"/activities/rage-buggy.html" },
  { id:2, name:"Off-Road Karting", cat:"Adrenaline", price:30, tier:2, beginner:true, solo:true, area:"Croydon", rating:4.4, blurb:"The cheapest adrenaline hit near London — a full day on track.", emoji:"🏁", img:"https://picsum.photos/seed/bucketday2/400/300", url:"https://www.trackdays.co.uk" },
  { id:3, name:"Indoor Skydiving", cat:"Adrenaline", price:55, tier:1, beginner:true, solo:true, area:"Basingstoke", rating:4.7, blurb:"Float on a column of air. Weatherproof freefall, any day.", emoji:"🪂", img:"https://picsum.photos/seed/bucketday3/400/300", url:"/activities/indoor-skydiving.html" },
  { id:4, name:"Tandem Skydive", cat:"Adrenaline", price:230, tier:1, beginner:true, solo:true, area:"North London", rating:4.9, blurb:"10,000ft, strapped to a pro. The one you'll never forget.", emoji:"☁️", img:"https://picsum.photos/seed/bucketday4/400/300", url:"/activities/tandem-skydive.html" },
  { id:5, name:"Axe Throwing", cat:"Adrenaline", price:30, tier:2, beginner:true, solo:true, area:"Central London", rating:4.6, blurb:"Stick it in the bullseye. Weirdly addictive, fully coached.", emoji:"🪓", img:"https://picsum.photos/seed/bucketday5/400/300", url:"https://www.whistlepunks.com" },
  { id:6, name:"Aeroplane Trial Lesson", cat:"Flying", price:165, tier:1, beginner:true, solo:true, area:"Denham", rating:4.9, blurb:"Take the controls over the Chilterns. You actually fly it.", emoji:"✈️", img:"https://picsum.photos/seed/bucketday6/400/300", url:"/activities/aeroplane-trial-lesson.html" },
  { id:7, name:"Helicopter Trial Lesson", cat:"Flying", price:250, tier:2, beginner:true, solo:true, area:"Elstree", rating:4.8, blurb:"Hover, bank, and turn — dual controls, real stick time.", emoji:"🚁", img:"https://picsum.photos/seed/bucketday7/400/300", url:"https://www.virginexperiencedays.co.uk" },
  { id:8, name:"Hot Air Balloon Flight", cat:"Flying", price:150, tier:2, beginner:true, solo:true, area:"Greater London", rating:4.7, blurb:"Drift over the capital at sunrise. Bucket-list calm.", emoji:"🎈", img:"https://picsum.photos/seed/bucketday8/400/300", url:"https://www.virginexperiencedays.co.uk" },
  { id:9, name:"Clay Pigeon Shooting", cat:"Shooting", price:50, tier:1, beginner:true, solo:true, area:"West London", rating:4.8, blurb:"Smash your first clay within minutes. Pro instructor included.", emoji:"🎯", img:"https://picsum.photos/seed/bucketday9/400/300", url:"/activities/clay-pigeon-shooting.html" },
  { id:10, name:"Paddleboarding", cat:"Water", price:40, tier:2, beginner:true, solo:true, area:"Paddington Basin", rating:4.5, blurb:"Stand, balance, glide the calm canal. Surprise core workout.", emoji:"🏄", img:"https://picsum.photos/seed/bucketday10/400/300", url:"https://www.getyourguide.com" },
  { id:11, name:"Kayaking Taster", cat:"Water", price:45, tier:2, beginner:true, solo:true, area:"Lee Valley", rating:4.6, blurb:"Beginner paddle on still water with a guide alongside.", emoji:"🛶", img:"https://picsum.photos/seed/bucketday11/400/300", url:"https://www.getyourguide.com" },
  { id:12, name:"Drum Taster Lesson", cat:"Creative", price:30, tier:2, beginner:true, solo:true, area:"City of London", rating:4.9, blurb:"Adults-only studio, kit provided, play a beat in an hour.", emoji:"🥁", img:"https://picsum.photos/seed/bucketday12/400/300", url:"https://www.superprof.co.uk" },
  { id:13, name:"Pottery Wheel Class", cat:"Creative", price:48, tier:2, beginner:true, solo:true, area:"Hackney", rating:4.8, blurb:"Throw a bowl on the wheel. Leave with something you made.", emoji:"🏺", img:"https://picsum.photos/seed/bucketday13/400/300", url:"https://www.obby.co.uk" },
  { id:14, name:"Cocktail Masterclass", cat:"Food & Drink", price:45, tier:2, beginner:true, solo:false, area:"Shoreditch", rating:4.7, blurb:"Shake three classics under a bartender's eye. Then drink them.", emoji:"🍸", img:"https://picsum.photos/seed/bucketday14/400/300", url:"https://www.designmynight.com" },
  { id:15, name:"Bottomless Brunch", cat:"Food & Drink", price:40, tier:2, beginner:true, solo:false, area:"Soho", rating:4.5, blurb:"Two hours of free-flowing drinks and food. Bring the crew.", emoji:"🥂", img:"https://picsum.photos/seed/bucketday15/400/300", url:"https://www.designmynight.com" },
  { id:16, name:"Gin Tasting", cat:"Food & Drink", price:42, tier:2, beginner:true, solo:false, area:"Borough", rating:4.6, blurb:"A guided flight of craft gins with the distiller's notes.", emoji:"🍹", img:"https://picsum.photos/seed/bucketday16/400/300", url:"https://www.designmynight.com" },
  { id:17, name:"Spa Day", cat:"Wellness", price:89, tier:2, beginner:true, solo:true, area:"Central London", rating:4.7, blurb:"Thermal suite, a treatment, and nowhere to be. Reset.", emoji:"💆", img:"https://picsum.photos/seed/bucketday17/400/300", url:"https://www.spabreaks.com" },
  { id:18, name:"Bouldering Session", cat:"Wellness", price:18, tier:2, beginner:true, solo:true, area:"Acton", rating:4.6, blurb:"Ropeless climbing near Ealing. Hooked by the first wall.", emoji:"🧗", img:"https://picsum.photos/seed/bucketday18/400/300", url:"https://www.thearchclimbingwall.com" },
  { id:19, name:"Thames Evening Cruise", cat:"Days Out", price:37, tier:1, beginner:true, solo:true, area:"Westminster Pier", rating:4.7, blurb:"Landmarks lit gold, gliding under Tower Bridge. Two hours.", emoji:"🛳️", img:"https://picsum.photos/seed/bucketday19/400/300", url:"/activities/thames-evening-cruise.html" },
  { id:20, name:"London Eye Ticket", cat:"Days Out", price:32, tier:2, beginner:true, solo:true, area:"South Bank", rating:4.5, blurb:"The whole skyline from 135 metres. The classic for a reason.", emoji:"🎡", img:"https://picsum.photos/seed/bucketday20/400/300", url:"https://www.getyourguide.com" },
  { id:21, name:"Comedy Club Night", cat:"Nightlife", price:22, tier:2, beginner:true, solo:true, area:"Soho", rating:4.6, blurb:"Circuit pros and rising names, close enough to heckle.", emoji:"🎤", img:"https://picsum.photos/seed/bucketday21/400/300", url:"https://www.designmynight.com" },
  { id:22, name:"Karaoke Private Room", cat:"Nightlife", price:20, tier:2, beginner:true, solo:false, area:"Chinatown", rating:4.4, blurb:"Your booth, your playlist, no judgement. Bring friends.", emoji:"🎶", img:"https://picsum.photos/seed/bucketday22/400/300", url:"https://www.designmynight.com" },
];
    ...
    <footer className="ftr">
      <div className="ftr-in">
        ...
        <div className="ftr-cols">
          ...
          <div><h4>Explore</h4><a href="/guides/" style={{display:"block",fontSize:"14px",color:"#D6DAE6",marginBottom:"8px",textDecoration:"none"}}>Guides</a><a href="mailto:hello@bucketdays.co.uk" style={{display:"block",fontSize:"14px",color:"#D6DAE6",marginBottom:"8px",textDecoration:"none"}}>hello@bucketdays.co.uk</a><span>Refunds</span><span>Terms</span></div>
        </div>
      </div>

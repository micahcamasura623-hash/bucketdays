...
const ACTIVITIES = [
  { id:1, url:"/activities/rage-buggy.html", cat:"Adrenaline", price:70, tier:1, beginner:true, solo:true, area:"Redhill, Surrey", rating:4.8, blurb:"Throw a roll-caged dirt buggy round a mud track. No licence needed.", emoji:"🏎️", img:"https://picsum.photos/seed/bucketday1/400/300", url:"#" },
  { id:2, name:"Off-Road Karting", cat:"Adrenaline", price:30, tier:1, beginner:true, solo:true, area:"Croydon", rating:4.4, blurb:"The cheapest adrenaline hit near London — a full day on track.", emoji:"🏁", img:"https://picsum.photos/seed/bucketday2/400/300", url:"#" },
  { id:3, url:"/activities/indoor-skydiving.html", cat:"Adrenaline", price:55, tier:1, beginner:true, solo:true, area:"Basingstoke", rating:4.7, blurb:"Float on a column of air. Weatherproof freefall, any day.", emoji:"🪂", img:"https://picsum.photos/seed/bucketday3/400/300", url:"#" },
  { id:4, url:"/activities/tandem-skydive.html", cat:"Adrenaline", price:230, tier:1, beginner:true, solo:true, area:"North London", rating:4.9, blurb:"10,000ft, strapped to a pro. The one you'll never forget.", emoji:"☁️", img:"https://picsum.photos/seed/bucketday4/400/300", url:"#" },
  ...
  { id:6, url:"/activities/aeroplane-trial-lesson.html", cat:"Flying", price:165, tier:1, beginner:true, solo:true, area:"Denham", rating:4.9, blurb:"Take the controls over the Chilterns. You actually fly it.", emoji:"✈️", img:"https://picsum.photos/seed/bucketday6/400/300", url:"#" },
  { id:7, name:"Helicopter Trial Lesson", cat:"Flying", price:250, tier:1, beginner:true, solo:true, area:"Elstree", rating:4.8, blurb:"Hover, bank, and turn — dual controls, real stick time.", emoji:"🚁", img:"https://picsum.photos/seed/bucketday7/400/300", url:"#" },
  ...
  { id:9, url:"/activities/clay-pigeon-shooting.html", cat:"Shooting", price:50, tier:1, beginner:true, solo:true, area:"West London", rating:4.8, blurb:"Smash your first clay within minutes. Pro instructor included.", emoji:"🎯", img:"https://picsum.photos/seed/bucketday9/400/300", url:"#" },
  ...
  { id:12, name:"Drum Taster Lesson", cat:"Creative", price:30, tier:1, beginner:true, solo:true, area:"City of London", rating:4.9, blurb:"Adults-only studio, kit provided, play a beat in an hour.", emoji:"🥁", img:"https://picsum.photos/seed/bucketday12/400/300", url:"#" },
  ...
  { id:19, url:"/activities/thames-evening-cruise.html", cat:"Days Out", price:37, tier:1, beginner:true, solo:true, area:"Westminster Pier", rating:4.7, blurb:"Landmarks lit gold, gliding under Tower Bridge. Two hours.", emoji:"🛳️", img:"https://picsum.photos/seed/bucketday19/400/300", url:"#" },

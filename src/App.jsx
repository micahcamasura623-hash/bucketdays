...
const ACTIVITIES = [
  ...
  { id:2, name:"Off-Road Karting", cat:"Adrenaline", price:30, tier:1, beginner:true, solo:true, area:"Croydon", rating:4.4, blurb:"The cheapest adrenaline hit near London — a full day on track.", emoji:"🏁", img:"https://picsum.photos/seed/bucketday2/400/300", url:"/activities/off-road-karting.html" },
  ...
  { id:5, name:"Axe Throwing", cat:"Adrenaline", price:30, tier:1, beginner:true, solo:true, area:"Central London", rating:4.6, blurb:"Stick it in the bullseye. Weirdly addictive, fully coached.", emoji:"🪓", img:"https://picsum.photos/seed/bucketday5/400/300", url:"/activities/axe-throwing.html" },
  ...
  { id:7, name:"Helicopter Trial Lesson", cat:"Flying", price:250, tier:1, beginner:true, solo:true, area:"Elstree", rating:4.8, blurb:"Hover, bank, and turn — dual controls, real stick time.", emoji:"🚁", img:"https://picsum.photos/seed/bucketday7/400/300", url:"/activities/helicopter-trial-lesson.html" },
  { id:8, name:"Hot Air Balloon Flight", cat:"Flying", price:150, tier:1, beginner:true, solo:true, area:"Greater London", rating:4.7, blurb:"Drift over the capital at sunrise. Bucket-list calm.", emoji:"🎈", img:"https://picsum.photos/seed/bucketday8/400/300", url:"/activities/hot-air-balloon.html" },
  ...
  { id:10, name:"Paddleboarding", cat:"Water", price:40, tier:1, beginner:true, solo:true, area:"Paddington Basin", rating:4.5, blurb:"Stand, balance, glide the calm canal. Surprise core workout.", emoji:"🏄", img:"https://picsum.photos/seed/bucketday10/400/300", url:"/activities/paddleboarding.html" },
  { id:11, name:"Kayaking Taster", cat:"Water", price:45, tier:1, beginner:true, solo:true, area:"Lee Valley", rating:4.6, blurb:"Beginner paddle on still water with a guide alongside.", emoji:"🛶", img:"https://picsum.photos/seed/bucketday11/400/300", url:"/activities/kayaking-taster.html" },
  { id:12, name:"Drum Taster Lesson", cat:"Creative", price:30, tier:1, beginner:true, solo:true, area:"City of London", rating:4.9, blurb:"Adults-only studio, kit provided, play a beat in an hour.", emoji:"🥁", img:"https://picsum.photos/seed/bucketday12/400/300", url:"/activities/drum-taster-lesson.html" },
  { id:13, name:"Pottery Wheel Class", cat:"Creative", price:48, tier:1, beginner:true, solo:true, area:"Hackney", rating:4.8, blurb:"Throw a bowl on the wheel. Leave with something you made.", emoji:"🏺", img:"https://picsum.photos/seed/bucketday13/400/300", url:"/activities/pottery-wheel-class.html" },
  { id:14, name:"Cocktail Masterclass", cat:"Food & Drink", price:45, tier:1, beginner:true, solo:false, area:"Shoreditch", rating:4.7, blurb:"Shake three classics under a bartender's eye. Then drink them.", emoji:"🍸", img:"https://picsum.photos/seed/bucketday14/400/300", url:"/activities/cocktail-masterclass.html" },
  { id:15, name:"Bottomless Brunch", cat:"Food & Drink", price:40, tier:1, beginner:true, solo:false, area:"Soho", rating:4.5, blurb:"Two hours of free-flowing drinks and food. Bring the crew.", emoji:"🥂", img:"https://picsum.photos/seed/bucketday15/400/300", url:"/activities/bottomless-brunch.html" },
  { id:16, name:"Gin Tasting", cat:"Food & Drink", price:42, tier:1, beginner:true, solo:false, area:"Borough", rating:4.6, blurb:"A guided flight of craft gins with the distiller's notes.", emoji:"🍹", img:"https://picsum.photos/seed/bucketday16/400/300", url:"/activities/gin-tasting.html" },
  { id:17, name:"Spa Day", cat:"Wellness", price:89, tier:1, beginner:true, solo:true, area:"Central London", rating:4.7, blurb:"Thermal suite, a treatment, and nowhere to be. Reset.", emoji:"💆", img:"https://picsum.photos/seed/bucketday17/400/300", url:"/activities/spa-day.html" },
  { id:18, name:"Bouldering Session", cat:"Wellness", price:18, tier:1, beginner:true, solo:true, area:"Acton", rating:4.6, blurb:"Ropeless climbing near Ealing. Hooked by the first wall.", emoji:"🧗", img:"https://picsum.photos/seed/bucketday18/400/300", url:"/activities/bouldering.html" },
  ...
  { id:20, name:"London Eye Ticket", cat:"Days Out", price:32, tier:1, beginner:true, solo:true, area:"South Bank", rating:4.5, blurb:"The whole skyline from 135 metres. The classic for a reason.", emoji:"🎡", img:"https://picsum.photos/seed/bucketday20/400/300", url:"/activities/london-eye.html" },
  { id:21, name:"Comedy Club Night", cat:"Nightlife", price:22, tier:1, beginner:true, solo:true, area:"Soho", rating:4.6, blurb:"Circuit pros and rising names, close enough to heckle.", emoji:"🎤", img:"https://picsum.photos/seed/bucketday21/400/300", url:"/activities/comedy-club-night.html" },
  { id:22, name:"Karaoke Private Room", cat:"Nightlife", price:20, tier:1, beginner:true, solo:false, area:"Chinatown", rating:4.4, blurb:"Your booth, your playlist, no judgement. Bring friends.", emoji:"🎶", img:"https://picsum.photos/seed/bucketday22/400/300", url:"/activities/karaoke-private-room.html" },
];
